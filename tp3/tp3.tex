...
\chapter{Curvas características}
  ...
  \section{Actividad de laboratorio}
    ...
    \begin{table}[H]
    \centering
    \caption{Valores de $I_C$ y $V_{CE}$ medidos para distintos valores de $I_B$ y $V_{CC}$.}
    \resizebox{\textwidth}{!}{%
    ...
    \begin{axis}[
        ...
        title={Curvas de salida del transistor BC547}
    ]
    ...
    \end{axis}
    \end{tikzpicture}
    \caption{Curvas de salida del BC547 para distintas $I_B$}
    \end{figure}
